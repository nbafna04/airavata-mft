...
//    @Autowired
//    private ResourceBackend getBackend();
    ...
    public void getGDriveResource(GDriveResourceGetRequest request, StreamObserver<GDriveResource> responseObserver) {
        try {
            this.getBackend().getGDriveResource(request).ifPresentOrElse(resource -> {
                responseObserver.onNext(resource);
                responseObserver.onCompleted();
            }, () -> {
                responseObserver.onError(Status.INTERNAL
    ...
    public void createGDriveResource(GDriveResourceCreateRequest request,
        ...
        try {
            responseObserver.onNext(this.getBackend().createGDriveResource(request));
            responseObserver.onCompleted();
        } catch (Exception e) {
    ...
    public void updateGDriveResource(GDriveResourceUpdateRequest request, StreamObserver<Empty> responseObserver) {
        try {
            this.getBackend().updateGDriveResource(request);
            responseObserver.onCompleted();
        } catch (Exception e) {
    ...
    public void deleteGDriveResource(GDriveResourceDeleteRequest request, StreamObserver<Empty> responseObserver) {
        try {
            boolean res = this.getBackend().deleteGDriveResource(request);
            if (res) {
                responseObserver.onCompleted();
            } else {
                responseObserver
